...
{/* <section class="">
  <form class="flex gap-1 justify-center w-full font-medium text-gray-400 rounded-xl shadow-sm min-h-[61px]">
    <label for="promptInput" class="sr-only">Your prompt</label>
    <input
      type="text"
      id="promptInput"
...
//   <button class="flex overflow-hidden gap-2.5 justify-center items-center px-6 py-3 mt-7 font-semibold text-white whitespace-nowrap bg-blue-500 rounded-lg max-md:px-5"></button>
  return (
